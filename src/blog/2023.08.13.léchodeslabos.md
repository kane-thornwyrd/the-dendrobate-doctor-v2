...
Description
:   a man is walking, saying:
    > Science is probably the best thing humans ever invented.
    > _**Academia**_ on the other hand, really isn't.
:   – "Science Fictions" a comic based on the book by Dr. Stuart Ritchie (retranscrit par Jena Thornwyrd)
